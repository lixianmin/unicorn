    ...
    public partial class SaveAid : IOctetsWriter
    {
        ...
        public void Save(Stream stream, MetadataManager manager, bool isFullMode)
        {
            ...
            using (_bodyWriter = new OctetsWriter(bodyStream, mode))
            {
                ...
                _bodyWriter.Write(
                    "Hey guys, welcome to our magic world, any questions please contact me by lixianmin@live.com");
            }
        }
        ...
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.Byte);
        }

        public void Write(sbyte v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.SByte);
        }

        public void Write(short v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.Int16);
        }

        public void Write(ushort v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.UInt16);
        }

        public void Write(int v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.Int32);
        }

        public void Write(uint v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.UInt32);
        }

        public void Write(long v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.Int64);
        }

        public void Write(ulong v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.UInt64);
        }

        public void Write(float v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.Float);
        }

        public void Write(double v)
        {
            _bodyWriter.Write(v);
            _IncrementCounter(CountType.Double);
        }

        public void Write(float x, float y)
        {
            _bodyWriter.Write(x, y);
            _IncrementCounter(CountType.Vector2);
        }

        public void Write(float x, float y, float z)
        {
            _bodyWriter.Write(x, y, z);
            _IncrementCounter(CountType.Vector3);
        }

        public void Write(float x, float y, float z, float w)
        {
            _bodyWriter.Write(x, y, z, w);
            _IncrementCounter(CountType.Vector4);
        }
